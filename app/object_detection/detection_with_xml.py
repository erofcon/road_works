...
async def run_detection(creator_id: int, video_path: str, xml_path: str, description: str | None):
    ...
    detection_model_id = await detections_crud.create_detection(detection=detection_model)
