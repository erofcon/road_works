...
class XmlPars:
    ...
    def get_current_location(self, time: datetime) -> Location | None:
        ...
        return Location(latitude=self.__locations[index].get("lat"), longitude=self.__locations[index].get("lon"))
